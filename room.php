...
<html>
  ...
  <!--room1-->
    <div class="room1">
      <div class="heading1"><h1>Ocean View king</h1></div><br>
        <img src="images/room1.jpg" alt="room" class="img1">
          
          <div class="room11">
            <button class="btn1"><img src="cross.png" alt="cross" height="20px" width="20px"></button>
			
            <div class="heading2">
			  <p><h2>Ocean View King Room Amenities</h2><br>
			</div>
            <div class="heading3"><b>Welcome Amenities</b></div><br>
            Premium welcome amenity including Tequila Reserva de la Familia
	        Platinum, fruit<br> bowl and nuts
            <br><br>
			
            <div class="heading2"><b>Room Features</b></div>
            <ul>
              <li> King bed </li>
      ...
      <div class="content1">
        <div class="para">Authentic Mexican style meets modern luxury in the Ocean View King accommodations at The Raj Mahal.Providing ample space across 856 square feet
		and a terrace with a plunge pool and stellar views, this room is anything but standard.
		</div><br>
        ...
        <div class="a1"><a href="#room">Learn More</a></div><br>
        <div class="bo"><button class="bh" onclick="window.open('bookRoom.php')">Book Now</button></div>
        </div>
    ...
    <!--room2-->
    <div class="room2">
     <br> <div class="heading1-second-hotel"><h1>Ocean View Deluxe Two Queens</h1></div>
      <img src="images/room2.jpeg" alt="room" class="img2"><br><br>
      <div class="room12">
        <button class="btn2"><img src="cross.png" alt="cross" height="20px" width="20px"></button>
        <div class="heading2"><p><h2>Ocean View Deluxe Two Queens Room Amenities</h2><br></div>
        <div class="heading3"><b>Welcome Amenities</b></div><br>
        Premium welcome amenity including Tequila Reserva de la Familia Platinum,
		<br>fruit bowl and nuts
        <br><br>
      ...
      <div class="content2">
        <div class="para">Authentic Mexican style meets modern luxury in the Ocean View Deluxe Two Queens accommodations at The Raj Mahal. Each of these 856-square-foot rooms features a private terrace with a plunge pool, a spacious sitting area with natural sunlight and a fireplace, and locally inspired design details.<br><br>
          <table class="t2">
            <tr>
              <td><b>Price</b></td>
              <td>₹8000</td>
          ...
          <div class="a2"><a href="#room"> Learn More</a></div><br>
          <div class="bo"><button class="bh" onclick="window.open('bookRoom.php')">Book Now</button></div>
        </div>
      </div>
    ...
    <!--room3-->
    <div class="room3">
    <br>  <div class="heading1"><h1><center>Two Bedroom Ocean View Suite</center></h1></div><br>
      <img src="images/room3.png" alt="room" class="img3">
      <div class="room13">
        <button class="btn3"><img src="cross.png" alt="cross" height="20px" width="20px"></button>
        <div class="heading2"><p><h2>Two Bedroom Ocean View Suite Room Amenities</h2><br></div>
        <div class="heading3"><b>Welcome Amenities</b></div><br>
        Premium welcome amenity including Tequila Reserva de la Familia Platinum,
      ...
      <div class="content3">
        ...
        <div class="para">
		  With ample space for up to four guests, each of the Two Bedroom Ocean View Suites at The Resort at Rajmahal provides a restful oasis with stellar Pacific panoramas. Enjoy the convenience of a fully equipped kitchen and the luxury of a private terrace in this 2,685-square-foot suite.<br><br>
          <table class="t3">
            <tr>
              <td><b>Price</b></td>
              <td>₹10,000</td>
          ...
          <div class="a3"><a href="#room"> Learn More</a></div><br>
          <div class="bo"><button class="bh" onclick="window.open('bookRoom.php')">Book Now</button></div>
        </div>
